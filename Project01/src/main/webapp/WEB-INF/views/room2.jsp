    ...
    >
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="resources/images/suite.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="resources/images/suite2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="resources/images/suite3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="resources/images/suite4.jpg" />
        </div>  
...
<tr><th class=room_info>Suite Room<hr></th></tr>
<tr><td style='font-weight:bold;'>객실명</td><td>102호</td></tr>
<tr><td style='font-weight:bold;'>객실종류</td><td>스위트</td></tr>
<tr><td style='font-weight:bold;'>최대숙박인원</td><td>3</td></tr>
<tr><td style='font-weight:bold;'>숙박비</td><td>60,000원</td></tr>
