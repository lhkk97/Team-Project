    ...
    >
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="resources/images/double.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="resources/images/double2.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="resources/images/double3.jpg" />
        </div>
        <div class="swiper-slide">
          <img src="resources/images/double4.jpg" />
        </div>  
...
<tr><th class=room_info>Double Room<hr></th></tr>
<tr><td style='font-weight:bold;'>객실명</td><td>104호</td></tr>
<tr><td style='font-weight:bold;'>객실종류</td><td>더블</td></tr>
<tr><td style='font-weight:bold;'>최대숙박인원</td><td>2</td></tr>
<tr><td style='font-weight:bold;'>숙박비</td><td>80,000원</td></tr>
